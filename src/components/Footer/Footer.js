				...
				<div class="wrapper">
					...
					<div class="fadeInRight_inView">
						<div class="social-links-wrapper">
							...
							>
							<a
								href="https://www.linkedin.com/in/itsmichellehu"
								target="_blank"
							...
							>
							<a
								href="assets/files/MichelleHuResume.pdf"
								target="_blank"
								rel="noopener noreferrer"
								class="anchor-link"
								>Resume</a
							>
							<a
								href="mailto:mhu.contact@gmail.com"
								target="_blank"
								rel="noopener noreferrer"
								class="anchor-link mobile-only"
								>Email me</a
							>
							<div class="email-link-wrapper">
								<a
									href="mailto:hello@michellehu.com"
									class="email-link"
									>hello@michellehu.com</a
								>
						...
						<div
							class="cta-buttons hide"
							aria-hidden="true"
						>
							<button
								id="scrollToProjects"
								class="btn-primary scroll-button"
							>
								See my work
							</button>
