class AutoplayVideoCarousel {
	...
	initializeCarouselElement() {
		...
		this.carouselElement.carouselContainer = this.carouselElement.querySelectorAll(
			this.selectors.carouselContainer
		);
	...
	updateSlidePositionByDrag() {
		...
		if (movedBy < -100 && this.state.currentIndex < this.carouselElement.carouselSlides.length - 1)
